...
const products = [
    {
        ...
        desc: "আকর্ষণীয় ডিজাইনের প্রিমিয়াম কোয়ালিটির ব্ল্যাক হুডি। উন্নত ফেব্রিক যা আপনাকে দেবে আরামদায়ক অনুভূতি।"
    },
    {
        id: 2,
        ...
        desc: "দারুণ স্টাইলিশ গ্রিন হুডি। এর চোখ ধাঁধানো রং এবং নরম ফেব্রিক আপনাকে উষ্ণ রাখার পাশাপাশি ফ্যাশনেবল রাখবে।"
    },
    {
        id: 3,
        ...
        desc: "ULTRA-MOISTURIZING ANTI-FRIZZ TREATMENT. চুল সোজা, সিল্কি এবং গ্লাসের মতো চকচকে করার জাদুকরী ফর্মুলা।"
    }
];

// --- Render Products with Scroll Reveal Class ---
const productGrid = document.getElementById('product-grid');
products.forEach(product => {
    const card = document.createElement('div');
    card.className = 'product-card reveal'; // Reveal class added
    card.innerHTML = `
...
function processOrder(e) {
    ...
    // আপনার দেওয়া Service ID এবং Template ID
    emailjs.send('service_n9sopis', 'template_8t9gx5f', orderData)
        .then(function(response) {
            ...
            alert("দুঃখিত, ইন্টারনেট সমস্যার কারণে অর্ডারটি সম্পন্ন হয়নি। দয়া করে আবার চেষ্টা করুন।");
